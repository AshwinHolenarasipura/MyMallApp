...
public class CategoryShoppingFragment extends Fragment {
    private static final String TAG = "CategoryShoppingFragment";

    private RecyclerView recyview;

    private FirebaseFirestore mFirestore;

    private RecyclerViewAdapter_Shopping_Category adapter;
    ...
    private void setcategory() {
        ...
        mFirestore.collection("shopping_category").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    private void recyclerview() {
        ...
        adapter = new RecyclerViewAdapter_Shopping_Category(category_list, getContext());
